...
public class JSQMessagesKeyboardController: NSObject, UIGestureRecognizerDelegate {
    ...
    func jsq_registerForNotifications() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesKeyboardController.jsq_didReceiveKeyboardDidShowNotification(_:)), name: UIKeyboardDidShowNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesKeyboardController.jsq_didReceiveKeyboardWillChangeFrameNotification(_:)), name: UIKeyboardWillChangeFrameNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesKeyboardController.jsq_didReceiveKeyboardDidChangeFrameNotification(_:)), name: UIKeyboardDidChangeFrameNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesKeyboardController.jsq_didReceiveKeyboardDidHideNotification(_:)), name: UIKeyboardDidHideNotification, object: nil)
    }
