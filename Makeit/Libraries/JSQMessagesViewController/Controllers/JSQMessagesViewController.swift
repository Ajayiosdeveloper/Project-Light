...
public class JSQMessagesViewController: UIViewController, JSQMessagesCollectionViewDataSource, JSQMessagesCollectionViewDelegateFlowLayout, UITextViewDelegate, JSQMessagesInputToolbarDelegate, JSQMessagesKeyboardControllerDelegate {
    ...
    func jsq_didReceiveMenuWillShowNotification(notification: NSNotification) {
        ...
        if let selectedIndexPathForMenu = self.selectedIndexPathForMenu {
            ...
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesViewController.jsq_didReceiveMenuWillShowNotification(_:)), name: UIMenuControllerWillShowMenuNotification, object: nil)
        }
    }
    ...
    func jsq_registerForNotifications(register: Bool) {
        ...
        if register {
            ...
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesViewController.jsq_handleDidChangeStatusBarFrameNotification(_:)), name: UIApplicationDidChangeStatusBarFrameNotification, object: nil)
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesViewController.jsq_didReceiveMenuWillShowNotification(_:)), name: UIMenuControllerWillShowMenuNotification, object: nil)
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(JSQMessagesViewController.jsq_didReceiveMenuWillHideNotification(_:)), name: UIMenuControllerWillHideMenuNotification, object: nil)
        }
        else {
